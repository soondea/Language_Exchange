...
print 'It took ' + i + ' iterations to sort the deck.';</code>
			...
			<h5>Left &amp; Right</h5>
			<p>
				<span class="image left"><img src="images/pic04.jpg" alt="" /></span>Morbi
			...
			<p>
				<span class="image right"><img src="images/pic05.jpg" alt="" /></span>Vestibulum
				...
				Praesent sit amet posuere risus, eu faucibus lectus. Vivamus ex
				...
				elementum varius. Nam sapien ante, varius in pulvinar vitae, rhoncus
				id massa. Donec varius ex in mauris ornare, eget euismod urna
				egestas. Etiam lacinia tempor ipsum, sodales porttitor justo.
